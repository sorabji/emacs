...
;;console
(defun sf-console-interactive ()
  "call the console of Sf for interactive goodness"
  (interactive)
  (djcb-term-start-or-switch (concat (expand-file-name "php app/console -s" (eproject-root)))))
