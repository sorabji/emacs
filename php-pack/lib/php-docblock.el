;;; php-docblock.el --- doc block generator/extractor for php
...
(defun php-insert-doc-block ()
  "Insert php-docblock block for current function, class or variable."
  (interactive)
  (let ((end (point)))
    (when (looking-at "\\s\)")
      (backward-list 1))
...
(defun php-insert-doc-block-for-function (attributes arglist)
  "Insert php-docblock block for the specified function"
...
(defun php-insert-doc-block-for-string (sig)
  "Insert php-docblock block for provided function, class or variable signature"
  (catch 'handled
    (insert "/**\n* \n*\n")
